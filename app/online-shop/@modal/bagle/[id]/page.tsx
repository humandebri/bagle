...
export default function BagelModal({ params }: { params: { id: string } }) {
  ...
  return (
    <div
      ...
      `}
    >
      <div className="relative bg-white p-6 w-full max-w-md mx-auto shadow-lg md:rounded-lg md:my-auto">
        {/* ✕ 閉じるボタン（モバイルでも表示） */}
        ...
        <h3 className="text-xl text-gray-400 mb-4">{bagel.description}</h3>
        ...
        {/* ボタン */}
        <button className="w-full my-4 py-5 bg-[#887c5d] text-white rounded hover:bg-gray-500">
